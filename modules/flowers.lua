...
function define_flower()
  ...
  local redclover_def = {
    ...
    desc = "Red Clover is a gorgeous species of clover native to North America. The entire plant can be eaten raw, or made into jam or tea.",
    shop_sell = 2,
    aquatic = false,
    variants = 4,
    chance = 50,
    effect = "Contented",
    effect_desc = "This flower increases the amount of honey a species will fill a frame with.",
    deep = false}
  
  
  local res api_define_flower(redclover_def, 
  ...
  local res api_define_flower_recipe("flower1", "flower4", "flower12")
  api_log("Combristle recipe define", res)
  -- 
